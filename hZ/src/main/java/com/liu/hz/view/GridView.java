...
public class GridView extends AbsListView {
    ...
    public GridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.GridView, defStyle, 0);
...
//    }
    ...
    private View fillDown(int pos, int nextTop) {
        ...
        // I think this is not required (j.m.)
//        setVisibleRangeHint(mFirstPosition, mFirstPosition + getChildCount() - 1);
    ...
    private View makeRow(int startPos, int y, boolean flow) {
        ...
        final boolean isLayoutRtl = Compat.isLayoutRtl(this);
...
//        setVisibleRangeHint(mFirstPosition, mFirstPosition + getChildCount() - 1);
    ...
    private View fillSelection(int childrenTop, int childrenBottom) {
        ...
        if (!mStackFromBottom) {
            ...
            offsetChildrenTopAndBottomUnhide(offset);
    ...
    private void correctTooHigh(int numColumns, int verticalSpacing, int childCount) {
        ...
        if (lastPosition == mItemCount - 1 && childCount > 0) {
            ...
            final int bottom = getBottom();
            final int top = getTop();
            final int end = (bottom - top) - mListPadding.bottom;
...
//    @android.view.RemotableViewMethod
    ...
    protected void layoutChildren() {
        ...
        try {
            ...
            final int bottom = getBottom();
            final int top = getTop();
            final int childrenBottom = bottom - top - mListPadding.bottom;
    ...
    private void setupChild(View child, int position, int y, boolean flow, int childrenLeft,
        ...
        if (recycled && (((LayoutParams)child.getLayoutParams()).scrappedFromPosition)
                != position) {
     ...
     *
     * @param direction either {@link android.view.View#FOCUS_LEFT}, {@link android.view.View#FOCUS_RIGHT},
     *        {@link android.view.View#FOCUS_UP} or {@link android.view.View#FOCUS_DOWN}
     *
     * @return whether selection was moved
     */
    ...
    protected int computeVerticalScrollRange() {
        ...
        if (scrollY != 0) {
            ...
            result += Math.abs((int) ((float) scrollY / getHeight() * rowCount * 100));
        }
        return result;
    }
